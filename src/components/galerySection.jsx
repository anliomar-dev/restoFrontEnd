	...
	return (
	  <motion.section
	    className="bg-secondaryBackground px-8 md:px-28
	        ...
	        items-center justify-center" id="gallery"
		    initial="hidden"
		    whileInView="visible"
	    ...
	    >
		  ...
		  <motion.p className="mt-3 font-bold text-5xl font-headingFont" variants={item}>
			  <span>Notre</span><span className="text-accentHover">Gallerie</span>
		  </motion.p>
		  <GallerySlider />
	  </motion.section>
	)
