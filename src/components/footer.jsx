...
function SocialMediaIcons(){
    return (
      <div className="flex gap-x-6 social-media">
          <a href="" className="p-3"><Facebook size={18}  /></a>
          <a href="" className="p-3"><Instagram size={18} /></a>
          <a href="" className="p-3"><Linkedin size={18} /></a>
      </div>
    )
}
    ...
    return (
      <footer className="footer px-28 flex flex-col justify-center py-12 bg-footerBG">
          <div className="footer-contact-infos flex justify-between flex-wrap gap-20">
              ...
              <div className="flex me-10">
                  ...
                  <div className="contact-info flex flex-col">
                      ...
                      <p><strong>Télephone :</strong> +230 54297857</p>
                      <p><strong>Email :</strong> omaranli56@gmail.com</p>
                  </div>
              </div>
              <div className="flex me-10">
                  ...
                  <div className="contact-info flex flex-col">
                      ...
                      <p className="text-white"><strong>Lundi-vendredi :</strong> 11h:30 - 23h</p>
                      <p className="text-white"><strong>Samedi, Dimanche :</strong> Fermé</p>
                  </div>
              </div>
              <div className="flex flex-col">
                  <h4 className="mb-3 font-bold text-lg"><strong>Suivez-nous !</strong></h4>
                  <SocialMediaIcons />
              </div>
          </div>
          ...
          <div className="footer-copyright flex flex-col justify-center items-center w-full">
              ...
              <p className="text-center pt-3 text-md">&#169; <strong>Le Banquet</strong> 2024: Tout droit reservé.</p>
          </div>
      </footer>
    )
}
