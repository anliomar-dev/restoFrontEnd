	...
	return (
	  <section className="px-8 md:px-28 flex flex-col justify-center items-center py-16 mt-5" id="reservation">
		  ...
		  <motion.div
		    ...
		    viewport={{ once: true, amount: 0.5 }}
		  >
			  <motion.div className="w-full lg:w-[415px] flex justify-center" variants={item}>
				  <img src={reservation} alt="reservation image" className="h-96 w-full" />
			  </motion.div>
			  <motion.div className="flex flex-col items-center w-full px-8 lg:px-16 mb-6" variants={item}>
				  <BookTableForm />
			  </motion.div>
		  </motion.div>
	  </section>
